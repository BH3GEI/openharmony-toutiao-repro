...
public class ActivityManagerRouting extends ActivityManagerAdapter {
    ...
    private static ClassLoader appClassLoader() {
        try {
            ...
            if (cur != null) {
                Object bound = readFieldValue(cur, "mBoundApplication");
                if (bound != null) {
                    Object info = readFieldValue(bound, "info");
                    if (info != null) {
                        Method m = findMethod(info.getClass(), "getClassLoader");
                        if (m != null) {
                            m.setAccessible(true);
                            Object cl = m.invoke(info);
